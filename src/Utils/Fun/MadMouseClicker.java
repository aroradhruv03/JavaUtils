...
public class MadMouseClicker
{
    ...
    public static void main(String[] args) throws Exception
    {
         ...
         **/
        int clicksPerMiliSec = 10;

        int timeOut = 5; // No of seconds after which this prog will start.!
        int duration = 5;  // Set the duration here... 5 here means 5 seconds of clicks!
